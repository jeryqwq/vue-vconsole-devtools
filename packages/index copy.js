...
class VConsoleVueTab extends VConsolePlugin {
  ...
  onReady() {
    target = document.getElementById('vue-iframe2')
    console.log(target)
...
function inject (scriptContent, done) {
  const div = document.getElementById('vue-iframe2').contentWindow.document.createElement("div") 
  div.setAttribute("id","app")
  document.getElementById('vue-iframe2').contentWindow.document.body.appendChild(div)
  const script = document.getElementById('vue-iframe2').contentWindow.document.createElement('script')
  script.text = scriptContent
  document.getElementById('vue-iframe2').contentWindow.document.body.appendChild(script)
}
